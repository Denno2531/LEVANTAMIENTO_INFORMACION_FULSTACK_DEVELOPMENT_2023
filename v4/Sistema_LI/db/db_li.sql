...
CREATE TABLE IF NOT EXISTS `emprendedor` (
  ...
  `salesyear1` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish2_ci NOT NULL,
  `salesyear2` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish2_ci NOT NULL,
  `salesyear3` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish2_ci NOT NULL,
  `salesyear4` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish2_ci NOT NULL,
  `heritage` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish2_ci NOT NULL,
  `heritage1` varchar(50) COLLATE utf8mb3_spanish2_ci NOT NULL,
  `heritage2` varchar(50) COLLATE utf8mb3_spanish2_ci NOT NULL,
  `heritage3` varchar(50) COLLATE utf8mb3_spanish2_ci NOT NULL,
  `heritage4` varchar(50) COLLATE utf8mb3_spanish2_ci NOT NULL,
