...
if ($result = $conexion->query($sql)) {
	if ($row = mysqli_fetch_array($result)) {
		...
		$sql_update = "UPDATE emprendedor SET name = '" . trim($_POST['txtname']) . "', surnames = '" . trim($_POST['txtsurnames']) . "', cedula = '" . trim($_POST['txtcurp']) . "', address = '" . trim($_POST['txtrfc']) . "', date_of_birth = '" . trim($_POST['dateofbirth']) . "', city = '" . trim($_POST['txtcity']) ."', workinghours = '" . trim($_POST['txtworkinghours']) ."', education = '" . trim($_POST['selecteducation']) ."', socialnetworks = '" . trim($_POST['selectsocialnetworks']) ."', salesyear = '" . trim($_POST['txtsalesyear']) ."', salesyear1 = '" . trim($_POST['txtsalesyear1']) . "', salesyear2 = '" . trim($_POST['txtsalesyear2']) ."', salesyear3 = '" . trim($_POST['txtsalesyear3']) ."', salesyear4 = '" . trim($_POST['txtsalesyear4']) ."', heritage = '" . trim($_POST['txtheritage']) ."', heritage1 = '" . trim($_POST['txtheritage1']) ."', heritage2 = '" . trim($_POST['txtheritage2']) ."', heritage3 = '" . trim($_POST['txtheritage3']) ."', heritage4 = '" . trim($_POST['txtheritage4']) . "', gender = '" . trim($_POST['selectGender']) . "', phone = '" . trim($_POST['txtphone']) . "', email = '" . trim($_POST['txtaddress']) . "', pass = '" . trim($_POST['txtpass']) . "', organization = '" . trim($_POST['selectorganization']) ."', nameorganization = '" . trim($_POST['txtnameorganization']) ."', state = '" . trim($_POST['selectstate']) ."', startdate = '" . trim($_POST['startdate']) ."', socialsales = '" . trim($_POST['selectsocialsales']) . "', updated_at = '" . $date . "' WHERE user = '" . trim($_POST['txtuserid']) . "'";
