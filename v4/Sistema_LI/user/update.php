	...
	if ($row = mysqli_fetch_array($result)) {
		...
		$sql_update = "UPDATE emprendedor SET name = '" . trim($_POST['txtname']) . "', surnames = '" . trim($_POST['txtsurnames']) .
		 ...
		 "', address = '" . trim($_POST['txtrfc']) . "', date_of_birth = '" . trim($_POST['dateofbirth']) .
		  ...
		  "', salesyear = '" . trim($_POST['txtsalesyear']) ."', salesyear1 = '" . trim($_POST['txtsalesyear1']) . 
		  "', salesyear2 = '" . trim($_POST['txtsalesyear2']) ."', salesyear3 = '" . trim($_POST['txtsalesyear3']) .
		  ...
		  "' WHERE user = '" . trim($_POST['txtuserid']) . "'";
