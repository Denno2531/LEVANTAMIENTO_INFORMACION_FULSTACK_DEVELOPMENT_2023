...
if ($result = $conexion->query($sql)) {
	if ($row = mysqli_fetch_array($result)) {
		...
		$sql_update = "UPDATE emprendedor SET name = '" . trim($_POST['txtname']) . "', surnames = '" . trim($_POST['txtsurnames']) . "', cedula = '" . trim($_POST['txtcurp']) . "', address = '" . trim($_POST['txtrfc']) . "', date_of_birth = '" . trim($_POST['dateofbirth']) . "', city = '" . trim($_POST['txtcity']) ."', workinghours = '" . trim($_POST['txtworkinghours']) ."', education = '" . trim($_POST['selecteducation']) ."', socialnetworks = '" . trim($_POST['selectsocialnetworks']) ."', salesyear = '" . trim($_POST['inputsalesyear']) ."', salesyear = '" . trim($_POST['inputsalesyear1']) . "', salesyear = '" . trim($_POST['inputsalesyear2']) ."', salesyear = '" . trim($_POST['inputsalesyear3']) ."', salesyear = '" . trim($_POST['inputsalesyear4']) ."', heritage = '" . trim($_POST['inputheritage']) ."', heritage = '" . trim($_POST['inputheritage1']) ."', heritage = '" . trim($_POST['inputheritage2']) ."', heritage = '" . trim($_POST['inputheritage3']) ."', heritage = '" . trim($_POST['inputheritage4']) . "', gender = '" . trim($_POST['selectGender']) . "', phone = '" . trim($_POST['txtphone']) . "', email = '" . trim($_POST['txtaddress']) . "', pass = '" . trim($_POST['txtpass']) . "', organization = '" . trim($_POST['selectorganization']) ."', nameorganization = '" . trim($_POST['txtnameorganization']) ."', state = '" . trim($_POST['selectstate']) ."', startdate = '" . trim($_POST['startdate']) ."', socialsales = '" . trim($_POST['selectsocialsales']) . "', updated_at = '" . $date . "' WHERE user = '" . trim($_POST['txtuserid']) . "'";
