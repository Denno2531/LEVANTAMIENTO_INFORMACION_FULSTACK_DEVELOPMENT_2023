...
<div class="form-gridview">
	<table class="default">
		<?php
		if ($_SESSION['total_department'] != 0) {
			echo '
					<tr>
						<th>Departamentos</th>
						<th>Nombre</th>
		...
		for ($i = 0; $i < $_SESSION['total_department']; $i++) {
			echo '
		    		<tr>
		    			<td>' . $_SESSION["id_department"][$i] . '</td>
						<td>' . $_SESSION["department_name"][$i] . '</td>
						<td>
							<form action="" method="POST">
								<input style="display:none;" type="text" name="txtcareer" value="' . $_SESSION["id_department"][$i] . '"/>
