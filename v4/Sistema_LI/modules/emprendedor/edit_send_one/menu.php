...
<div class="form-gridview">
  ...
  <div class="contenedor-info">
    ...
    <h2 class="information_student">Jerarquía:
      <?php echo $_SESSION['user_jerarquia']; ?>
    </h2>
    <h2 class="information_student">Departamento:
      <?php echo $_SESSION['user_departamento']; ?>
    </h2>
    <h2 class="information_student">Id:
      <?php echo $_SESSION['user_id']; ?>
    </h2>
    <h2 class="information_student">Cédula:
      <?php echo $_SESSION['user_cedula']; ?>
    </h2>
    <h2 class="information_student">Carrera:
      <?php echo $_SESSION['user_carrera']; ?>
    </h2>
    <h2 class="information_student">Sede:
      <?php echo $_SESSION['user_sede']; ?>
    </h2>
    <h2 class="information_student">Teléfono:
      <?php echo $_SESSION['user_telefono']; ?>
    </h2>
    <h2 class="information_student">Fecha de ingreso:
      <?php echo $_SESSION['user_ingreso']; ?>
    </h2>
    <h2 class="information_student">Fecha tentativa de salida:
      <?php echo $_SESSION['user_salida']; ?>
    </h2>
    ...
    <div class="textList">
      <div class="item downLeft rounded-blue-box">
        ...
        <form action="" method="POST">
          ...
          <button class="btn-menu-editor" id="btnSave" value="form_justificaciones" name="btn"
