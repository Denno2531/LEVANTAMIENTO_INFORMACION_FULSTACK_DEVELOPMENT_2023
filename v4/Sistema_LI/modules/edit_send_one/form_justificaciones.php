...
if (!empty($_POST['search'])) {
	...
	$sql = "SELECT * FROM justificaciones WHERE num LIKE '%" . $_POST['search'] . "%' OR archivo LIKE '%" . $_POST['search'] . "%' OR user LIKE '%" . $_POST['search'] . "%' OR descripcion LIKE '%" . $_POST['search'] . "%' ORDER BY num";
	...
	$sql = "SELECT * FROM justificaciones WHERE user = '" . $_POST['txtuserid'] . "' ORDER BY num";
...
<div class="form-gridview">
	<table class="default">
	<h2 class="titlecenter"> Justificación </h2>
		<?php 
