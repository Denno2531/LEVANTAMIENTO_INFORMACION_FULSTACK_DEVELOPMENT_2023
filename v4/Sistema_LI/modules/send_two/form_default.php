...
// Consulta SQL para obtener los archivos dele estudiante
$sql= "SELECT archivopdf, descripcion, estado FROM send_two WHERE user = '{$_SESSION['user']}'";
$resultado = $conexion->query($sql);

// Almacenar los datos de los archivos en la sesion
...
<div class="form-gridview">
    <table class="default">
        ...
        foreach ($_SESSION['sendtwo_data'] as $row) {
